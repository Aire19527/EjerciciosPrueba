...
namespace Operadores
{
    public class Ciclos
    {
        ...
        public void Evaluacion_2()
        {
            ...
            Console.WriteLine("Saludos...");
            Console.WriteLine("");
            Console.WriteLine("Será que puedes vencerme?");
            ...
            else
            {
                for (int i = 1; i < 10; i++)
                {
                    ...
                    {
                        Console.WriteLine($"Felicidades Adivinaste!!!!... En el {Diferencial + 2} intento");
                        break;
                    }
                    Diferencial = i;
        ...
        {
            //Algoritmo que pida números hasta que se introdusca un 0.
